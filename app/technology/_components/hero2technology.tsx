    ...
    <section className="w-full bg-[#f5f7fb] py-14 sm:py-16 md:py-20 px-4 sm:px-8 md:px-20 flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-10 overflow-hidden">
      ...
      >
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1a1a1a] mb-2 sm:mb-3 relative inline-block">
          <h3 className="text-[#d4af37] font-semibold text-sm uppercase mb-3">Telecommunications</h3>
          Telecommunications
      ...
      >
        <motion.div
          ...
          className="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 w-full sm:w-[90%] md:w-[85%]"
        >
          <Image
            ...
            width={600}
            height={400}
            className="object-cover w-full h-[220px] sm:h-[320px] md:h-[400px]"
          />
        </motion.div>
      </motion.div>
    </section>
