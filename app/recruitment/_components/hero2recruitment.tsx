  ...
  const processes = [
    {
      ...
      desc: "Learn more about how Efficient Tech Partnership  ensures linguistic excellence in every customer interaction.",
    },
    {
    ...
    <section className="w-full bg-[#f6faff] py-16 px-6 md:px-20">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        >
          ...
          <p className="text-gray-700 font-serif leading-relaxed">
            At Efficient Tech Partnership, we believe that outstanding customer service relies on
      ...
      <div className="mt-10 md:mt-32 bg-[#7ed957]/10 p-6 md:p-16 rounded-2xl shadow-md text-center">
        ...
        >
          ...
          Efficient Tech Partnership as your partner in exceptional customer service.
        </motion.p>
        <motion.button
