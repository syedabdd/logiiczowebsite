        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-10">
          ...
          >
            ...
            <p className="text-gray-700 font-serif leading-relaxed text-[16px] md:text-[17px]">
              ...
              <strong> Efficient Tech  Partnership</strong>, a renowned business process outsourcing
          ...
          >
            ...
            >
              <h3 className="text-lg font-semibold text-left text-[#1e2a47] mb-2 flex items-center gap-2">
                <span>💡</span> The Solution: Efficient Tech Partnership BPO Services
              </h3>
              <p className="text-gray-700 text-left font-serif leading-relaxed text-[15px]">
                To overcome these hurdles, the company partnered with Efficient Tech Partnership.
